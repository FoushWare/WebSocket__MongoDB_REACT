...
class App extends Component {
    ...
    componentDidMount = async () => {
        ...
        //  invoke changes when newThought added to the DataBase
        ...
        //  invoke changes when newThought removed from the DataBase
        ...
        // fetch thoughts from the [DB]
        await this.fetchThoughts();
    };

    //Fc... for fetching thoughts 
    fetchThoughts = async () => {
        try {
